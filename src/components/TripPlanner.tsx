...
// If not imported globally, uncomment this line:
...
const ALL_THEMES = ["hikes","waterfalls","lakes","cafes","viewpoints","parks","food","museums", "cities","restaurants", "beaches"] as const;
  ...
  return (
    <div className="h-screen grid grid-rows-[64px_1fr] bg-slate-950 text-slate-100">
      ...
      <header className="flex items-center gap-3 px-4 border-b border-slate-800 bg-slate-900/60 backdrop-blur">
        <div className="text-lg font-semibold tracking-tight">Trip Planner</div>
        <div className="text-xs text-slate-400">Directions + Places (no client key)</div>
      </header>

      {/* Body */}
      <div className="grid grid-cols-1 md:grid-cols-[380px_1fr] min-h-0">
        {/* Sidebar */}
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-t border-slate-800 bg-slate-900/70 backdrop-blur sticky bottom-0 z-10">
              <div className="grid gap-2">
                ...
                <button
                  onClick={() => { setSelectedIds(new Set()); setFinalPolyline(null); setFinalTotals(null); setFinalOrder(null); setFinalStopCards([]); }}
        ...
        <main className="relative min-h-0">
          ...
          {/* Legend — put above Leaflet controls */}
          ...
          {/* Trip summary panel — ensure it's ON TOP of Leaflet */}
          {finalTotals && (
            <div className="absolute left-3 bottom-3 md:left-auto md:right-3 md:bottom-3 z-[1002] max-w-[420px] w-[calc(100%-24px)] md:w-[380px]">
              <div className="rounded-2xl border border-slate-800 bg-slate-900/85 backdrop-blur shadow-lg">
                {/* header */}
                ...
                {/* stops list */}
                <div className="max-h-[40vh] overflow-y-auto scroll-area">
